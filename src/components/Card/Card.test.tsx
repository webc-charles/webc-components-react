...
describe('Card components', () => {
  ...
  it('renders Card with custom className', () => {
    render(<Card data-testid="card" className="extra">Card Content</Card>)
  ...
  it('renders CardHeader with custom className', () => {
    render(<CardHeader data-testid="header" className="header-class">Header Content</CardHeader>)
  ...
  it('renders CardBody with custom className', () => {
    render(<CardBody data-testid="body" className="body-class">Body Content</CardBody>)
  ...
  it('renders CardFooter with custom className', () => {
    render(<CardFooter data-testid="footer" className="footer-class">Footer Content</CardFooter>)
