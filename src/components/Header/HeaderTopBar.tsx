...
import type { HeaderTopBarTypes, HeaderTopBarLinkTypes } from './Header.types'

function HeaderTopBarLink({ asChild, children, className, ...props }: HeaderTopBarLinkTypes) {
...
function HeaderTopBarComponent({ ref, children, className, ...rest }: HeaderTopBarTypes) {
  return (
