...
describe('Iframe', () => {
  it('renders iframe element', () => {
    render(<Iframe src="https://example.com" title="Example" data-testid="iframe" />)
    expect(screen.getByTestId('iframe')).toBeInTheDocument()
  })

  it('has required title for accessibility', () => {
    render(<Iframe src="https://example.com" title="Accessible title" data-testid="iframe" />)
    expect(screen.getByTestId('iframe')).toHaveAttribute('title', 'Accessible title')
  })

  it('has src attribute', () => {
    render(<Iframe src="https://example.com" title="Example" data-testid="iframe" />)
    expect(screen.getByTestId('iframe')).toHaveAttribute('src', 'https://example.com')
  })
  ...
  it('can disable fullscreen', () => {
    render(<Iframe src="https://example.com" title="Example" allowFullScreen={false} data-testid="iframe" />)
    expect(screen.getByTestId('iframe')).not.toHaveAttribute('allowfullscreen')
  })

  it('applies aspect ratio style', () => {
    render(<Iframe src="https://example.com" title="Example" aspectRatio="16/9" data-testid="iframe" />)
    expect(screen.getByTestId('iframe')).toHaveStyle({ aspectRatio: '16/9' })
  })

  it('applies custom className', () => {
    render(<Iframe src="https://example.com" title="Example" className="custom" data-testid="iframe" />)
